...
[This list](https://github.com/rasbt/pattern_classification/blob/master/resources/python_data_libraries.md) was first compiled by [Sebastian Raschka](http://sebastianraschka.com/) to which we added some more potentially useful libraries.
